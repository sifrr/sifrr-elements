...
t.exports=function(){const t={};var e=class{constructor(e){const s=e.join("_");return t[s]||(this.setProps(...e),t[s]=this.final.bind(this)),t[s]}setProps(t,e,s,i){let n={x1:t,y1:e,x2:s,y2:i,A:(t,e)=>1-3*e+3*t,B:(t,e)=>3*e-6*t,C:t=>3*t,CalcBezier:(t,e,s)=>((this.A(e,s)*t+this.B(e,s))*t+this.C(e))*t,GetSlope:(t,e,s)=>3*this.A(e,s)*t*t+2*this.B(e,s)*t+this.C(e)};Object.assign(this,n)}final(t){return this.x1==this.y1&&this.x2==this.y2?t:this.CalcBezier(this.GetTForX(t),this.y1,this.y2)}GetTForX(t){let e=t;for(let s=0;s<4;++s){let s=this.GetSlope(e,this.x1,this.x2);if(0==s)return e;let i=this.CalcBezier(e,this.x1,this.x2)-t;e-=i/s}return e}},s={linear:[0,0,1,1],ease:[.25,.1,.25,1],easeIn:[.42,0,1,1],easeOut:[0,0,.58,1],easeInOut:[.42,0,.58,1]},i=t=>new Promise(e=>setTimeout(e,t));const n=/(\d+\.?\d*)/,o=new Set;window.requestAnimationFrame(function t(e){o.forEach(t=>t(e)),window.requestAnimationFrame(t)});var a=function({target:t,prop:a,from:r,to:l,time:h=300,type:d="ease",onUpdate:c,round:p=!1,delay:u=0}){const g=l.toString().split(n),f=g.length,b=[],m=[],v=[],y=(r||t[a]||"").toString().split(n),x="function"==typeof c;for(let t=0;t<f;t++){const e=Number(g[t]);isNaN(e)||!g[t]?b.push(g[t]):(m.push(Number(y[t])||0),v.push(e-(Number(y[t])||0)))}const w={raw:b};return i(u).then(()=>new Promise((i,n)=>{if(s[d])d=new e(s[d]);else if(Array.isArray(d))d=new e(d);else if("function"!=typeof d)return n(Error("type should be one of "+Object.keys(s).toString()+" or Bezier Array or Function, given "+d));let r=performance.now();const l=function(e){const s=(e-r)/h,u=d(s>=1?1:s),g=v.map((t,e)=>{const s=u*t+m[e];return p?Math.round(s):s}),f=String.raw(w,...g);try{t[a]=Number(f)||f,x&&c(t,a,t[a]),s>=1&&i(o.delete(l))}catch(t){o.delete(l),n(t)}};o.add(l)}))};function r({targets:t,target:e,to:s,time:i,type:n,onUpdate:o,round:r,delay:l}){t=t?Array.from(t):[e];let h=s,d=l,c=i;return Promise.all(t.map((t,e)=>("function"==typeof s&&(h=s(e)),"function"==typeof l&&(d=l(e)),"function"==typeof i&&(c=i(e)),function t(e,s,i,l){const h=[];for(let d in s){let c,p;Array.isArray(s[d])?[c,p]=s[d]:p=s[d],"object"!=typeof s[d]||Array.isArray(s[d])?h.push(a({target:e,prop:d,to:p,time:l,type:n,from:c,onUpdate:o,round:r,delay:i})):h.push(t(e[d],s[d],i,l))}return Promise.all(h)}(t,h,d,c))))}return r.types=s,r.wait=i,r.animate=r,r}();
