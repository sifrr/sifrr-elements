...
const template$5 = SifrrDom.template`<style media="screen">
  ${css$3}
</style>
<div class="container">
...
class SifrrProgressRound extends SifrrDom.Element {
  static get template() {
    return SifrrDom.template(`<style>${css$5}</style>${template$6}`);
  }
  static syncedAttrs() {
...
export { LazyLoader, SifrrCarousel, SifrrCodeEditor, SifrrInclude, SifrrLazyPicture, SifrrLazyImg as SifrrLazzyImg, SifrrProgressRound, SifrrShimmer, SifrrShowcase, SifrrStater, SifrrTabContainer, SifrrTabHeader, exitFullScreen, getParam, makeFullScreen, setParam };
/*! (c) @aadityataparia */
